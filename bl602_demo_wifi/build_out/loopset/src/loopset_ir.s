...
_ir_bloop_evt:
.LFB25:
	.file 1 "/Users/Sven/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_ir.c"
	.loc 1 52 1
	.cfi_startproc
.LVL0:
	.loc 1 53 5
...
.LVL6:
	...
	.loc 1 68 43
	.loc 1 68 48
	.loc 1 68 71 is_stmt 0
	lui	a5,%hi(_fsymc_level_loopset)
	.loc 1 68 51
	lbu	a4,%lo(_fsymc_level_loopset)(a5)
	li	a5,1
	bgtu	a4,a5,.L11
	.loc 1 68 117 discriminator 3
	lui	a4,%hi(_fsymf_level_loopsetloopset_ir)
	.loc 1 68 96 discriminator 3
	lbu	a4,%lo(_fsymf_level_loopsetloopset_ir)(a4)
	bgtu	a4,a5,.L11
.LVL7:
.LBB10:
.LBB11:
	.loc 1 68 156 is_stmt 1
.LBB12:
.LBB13:
...
.LFE28:
	...
	.comm	_fsymf_level_loopsetloopset_ir,1,1
	.comm	_fsymc_level_loopset,1,1
	.section	.rodata._ir_bloop_handler_holder.3455,"a"
	.align	2
	.set	.LANCHOR0,. + 0
	.type	_ir_bloop_handler_holder.3455, @object
	.size	_ir_bloop_handler_holder.3455, 12
_ir_bloop_handler_holder.3455:
	.word	.LC3
	.word	_ir_bloop_evt
	.word	_ir_bloop_msg
...
.LC1:
	...
	.zero	1
.LC2:
	.string	"[%10u][%s: %s:%4d] [IR] [MSG] called with msg info\r\n"
...
.Letext0:
	...
	.file 14 "/Users/Sven/bl_iot_sdk/components/sys/bloop/looprt/include/looprt.h"
	.file 15 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_ir.h"
	.file 16 "/Users/Sven/bl_iot_sdk/components/stage/yloop/include/aos/yloop.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	_ir_bloop_handler_holder.3455
	.byte	0x26
	.4byte	.LVL14
	.4byte	0xf76
	.byte	0x27
...
.LASF83:
	.string	"_p5s"
.LASF200:
	.string	"/Users/Sven/bl_iot_sdk/components/sys/bloop/loopset/src/loopset_ir.c"
.LASF178:
	.string	"list"
.LASF117:
