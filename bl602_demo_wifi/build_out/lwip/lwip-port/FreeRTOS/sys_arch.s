...
sys_mbox_new:
.LFB4:
	.file 1 "/Users/Sven/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
	.loc 1 55 1
	.cfi_startproc
.LVL0:
	.loc 1 56 5
...
.LVL7:
 ...
 #APP
# 83 "/Users/Sven/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c" 1
	 nop 
# 0 "" 2
	.loc 1 85 9
...
.LVL11:
.L11:
	.loc 1 102 136 is_stmt 1 discriminator 1
	.loc 1 102 13 is_stmt 0 discriminator 1
	lw	a0,0(s1)
	li	a3,0
	li	a2,-1
	addi	a1,sp,12
...
.L20:
	.cfi_restore_state
	.loc 1 175 103 is_stmt 1 discriminator 1
	.loc 1 175 40 is_stmt 0 discriminator 1
	lw	a0,0(s2)
	li	a2,-1
	mv	a1,s1
	call	xQueueReceive
.LVL34:
	.loc 1 175 14 discriminator 1
	bne	a0,s3,.L20
	j	.L27
	.cfi_endproc
.LFE8:
...
.LVL42:
	.loc 1 225 16
	sw	a0,0(s0)
	.loc 1 225 100 is_stmt 1
	.loc 1 225 102 is_stmt 0
	beq	a0,zero,.L34
	.loc 1 225 8 is_stmt 1 discriminator 1
	.loc 1 225 17 is_stmt 0 discriminator 1
	li	a3,0
	li	a2,0
	li	a1,0
	call	xQueueGenericSend
.LVL43:
.L34:
	.loc 1 225 56 is_stmt 1 discriminator 3
	.loc 1 226 5 discriminator 3
	.loc 1 226 8 is_stmt 0 discriminator 3
	lw	a0,0(s0)
	lui	s0,%hi(lwip_stats)
.LVL44:
	addi	s0,s0,%lo(lwip_stats)
	.loc 1 226 7 discriminator 3
	bne	a0,zero,.L35
...
.L44:
	.cfi_restore_state
	.loc 1 287 106 is_stmt 1 discriminator 1
	.loc 1 287 16 is_stmt 0 discriminator 1
	lw	a0,0(s1)
	li	a1,-1
	call	xQueueSemaphoreTake
.LVL56:
...
.Letext0:
	...
	.file 17 "/Users/Sven/bl_iot_sdk/components/network/lwip/lwip-port/arch/sys_arch.h"
	.file 18 "/Users/Sven/bl_iot_sdk/components/network/lwip/src/include/lwip/sys.h"
...
.LASF183:
	.string	"MEMP_PBUF"
.LASF277:
	.string	"/Users/Sven/bl_iot_sdk/components/network/lwip/lwip-port/FreeRTOS/sys_arch.c"
.LASF118:
