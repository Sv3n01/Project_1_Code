# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c"
# 1 "/Users/Sven/bl_iot_sdk/customer_app/bl602_demo_wifi/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c"
# 30 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c"
...
# 31 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 2
...
# 32 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 2
...
# 33 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 2
...
# 34 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 2
...
blog_level_t _fsymf_level_hal_drvbl_sys_cli;
const blog_info_t _fsymf_info_hal_drvbl_sys_cli __attribute__((used, section(".static_blogfile_code." "hal_drvbl_sys_cli"))) = { (blog_level_t *)(&_fsymf_level_hal_drvbl_sys_cli), (char *)("hal_drv.bl_sys_cli")};
...
# 35 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 2
...
static void clk(void *para)
{
    ...
    int hdiv = p->hdiv;
    int bdiv = p->bdiv;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_sys_cli) ) { bl_printk("[%10u][%s: %s:%4d] " "hdiv:%d, bdiv:%d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_sys_cli.c", 48, hdiv, bdiv); }} while(0==1);};
    ...
    vTaskExitCritical();
    vTaskDelete(
# 55 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 3 4
               ((void *)0)
# 55 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c"
                   );
}
...
static void cmd_clk_change(char *buf, int len, int argc, char **argv)
{
    para_div clk_div;
    if (3 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_sys_cli) ) { bl_printk("[%10u][%s: %s:%4d] " "please input para!\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_sys_cli.c", 62); }} while(0==1);};
        return;
    } else {
        clk_div.hdiv = atoi(argv[1]);
        clk_div.bdiv = atoi(argv[2]);
        xTaskCreate(clk, (char*)"clk", 512, &clk_div, 20, 
# 67 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c" 3 4
                                                         ((void *)0) 
# 67 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys_cli.c"
                                                              );
    }
}
