# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
# 1 "/Users/Sven/bl_iot_sdk/customer_app/bl602_demo_wifi/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
# 30 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
...
# 31 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 32 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 33 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 39 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/aon_reg.h"
...
# 40 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/aon_reg.h" 2
...
BL_Err_Type AON_Set_LDO11_SOC_Sstart_Delay(uint8_t delay);
              ;
# 35 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h" 1
# 40 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h"
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_aon.h" 1
...
# 36 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_common.h" 1
# 37 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h" 1
# 41 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h"
...
# 38 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 40 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 1
# 40 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h"
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/gpip_reg.h" 1
# 210 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/gpip_reg.h"
struct gpip_reg {
...
# 41 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h" 2
# 58 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h"
typedef enum {
    ADC_CHAN0,
    ADC_CHAN1,
    ADC_CHAN2,
...
# 500 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_adc.h"
...
# 41 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 43 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
blog_level_t _fsymf_level_hal_drvbl_adc;
const blog_info_t _fsymf_info_hal_drvbl_adc __attribute__((used, section(".static_blogfile_code." "hal_drvbl_adc"))) = { (blog_level_t *)(&_fsymf_level_hal_drvbl_adc), (char *)("hal_drv.bl_adc")};
...
# 44 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 48 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 49 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
# 50 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 2
...
void ADC_Clock_Init(uint8_t div)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " "GLB_Set_ADC_CLK_Div(%d) == clock 96M/(%d+1)\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_adc.c", 80,div,div); }} while(0==1);};
}
...
static void ADC_tsen_case(void)
{
    ...
    for(i=0;i<40;i++){
        ...
        if(i%2 !=0){
            ...
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " " v0=%ld  v1 = %ld \n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_adc.c", 140,v0,v1); }} while(0==1);};

            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " " chip Tempture = %ld degree centigrade\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_adc.c", 142,(uint32_t)(v_error)); }} while(0==1);};
        }
        if( i%2 ==0 )
            ADC_SET_TSVBE_HIGH();
        else
...
static void adc_data_update(void)
{
    ...
    if (pstctx == 
# 290 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                 ((void *)0)
# 290 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                     ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_ERROR >= _fsymc_level_hal_drv) && (BLOG_LEVEL_ERROR >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " "get ctx error \r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "bl_adc.c", 291); }} while(0==1);};
        return;
    }
    ...
    if (pstctx->cb != 
# 303 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                     ((void *)0)
# 303 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                         ) {
...
int bl_adc_dma_init(int mode, uint32_t data_num)
{
    ...
    if (data_num < 1) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_ERROR >= _fsymc_level_hal_drv) && (BLOG_LEVEL_ERROR >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " "illegal para. \r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "bl_adc.c", 427); }} while(0==1);};
    ...
    if (pstctx == 
# 433 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                 ((void *)0)
# 433 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                     ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_ERROR >= _fsymc_level_hal_drv) && (BLOG_LEVEL_ERROR >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " "malloc adc_ctx failed \r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "bl_adc.c", 434); }} while(0==1);};
    ...
    if (pstlli == 
# 440 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                 ((void *)0)
# 440 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                     ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_ERROR >= _fsymc_level_hal_drv) && (BLOG_LEVEL_ERROR >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " "malloc lli failed. \r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "bl_adc.c", 441); }} while(0==1);};
    ...
    if (llibuf == 
# 447 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                 ((void *)0)
# 447 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                     ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_ERROR >= _fsymc_level_hal_drv) && (BLOG_LEVEL_ERROR >= _fsymf_level_hal_drvbl_adc) ) { bl_printk("[%10u][%s: %s:%4d] " "malloc lli buf failed. \r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "bl_adc.c", 448); }} while(0==1);};
    ...
    pstctx->channel_data = 
# 466 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                          ((void *)0)
# 466 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                              ;
    pstctx->data_size = data_num;
    pstctx->cb = 
# 468 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                ((void *)0)
# 468 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                    ;
    bl_dma_irq_register(1, adc_data_update, 
# 469 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c" 3 4
                                                         ((void *)0)
# 469 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_adc.c"
                                                             , pstctx);
