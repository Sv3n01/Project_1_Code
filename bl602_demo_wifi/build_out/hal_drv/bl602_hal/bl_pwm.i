# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c"
# 1 "/Users/Sven/bl_iot_sdk/customer_app/bl602_demo_wifi/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c"
# 30 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c"
...
# 31 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 2
...
# 32 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 2
...
# 33 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 2

# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.h" 1
# 39 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.h"
...
# 35 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 2
...
# 36 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 2
...
blog_level_t _fsymf_level_hal_drvbl_pwm;
const blog_info_t _fsymf_info_hal_drvbl_pwm __attribute__((used, section(".static_blogfile_code." "hal_drvbl_pwm"))) = { (blog_level_t *)(&_fsymf_level_hal_drvbl_pwm), (char *)("hal_drv.bl_pwm")};
...
# 38 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 2
...
int32_t bl_pwm_init(uint8_t id, uint8_t pin, uint32_t freq)
{
    ...
    if ((freq < 2000) || (freq > 800000)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_ERROR >= _fsymc_level_hal_drv) && (BLOG_LEVEL_ERROR >= _fsymf_level_hal_drvbl_pwm) ) { bl_printk("[%10u][%s: %s:%4d] " "arg error. bl_pwm_init freq = %ld\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[31mERROR \x1b[0m", "bl_pwm.c", 89, freq); }} while(0==1);};
        return -1;
    }
...
int32_t bl_pwm_get_duty(uint8_t id, float *p_duty)
{
    ...
    if (
# 148 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c" 3 4
       ((void *)0) 
# 148 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_pwm.c"
            == p_duty) {
        return -1;
    }
    PWM_Channel_Get(id, &period, &threshold1, &threshold2);
