# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c"
# 1 "/Users/Sven/bl_iot_sdk/customer_app/bl602_demo_wifi/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c"
# 30 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c"
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 1
# 39 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h"
...
# 40 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 2
...
BL_Err_Type AON_Set_LDO11_SOC_Sstart_Delay(uint8_t delay);
              ;
# 41 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 2
...
# 42 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 2

# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_xip_sflash.h" 1
# 71 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_xip_sflash.h"
...
# 44 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 2


# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h" 1
# 39 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h"
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sec_eng_reg.h" 1
# 1197 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sec_eng_reg.h"
struct sec_eng_reg {
...
# 2250 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sec_eng_reg.h"
...
# 2732 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sec_eng_reg.h"
...
# 3204 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/sec_eng_reg.h"
...
# 40 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h" 2
# 57 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h"
typedef enum {
    SEC_ENG_AES_ID0,
}SEC_ENG_AES_ID_Type;
...
# 430 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h"
...
void SEC_Eng_Turn_Off_Sec_Ring(void);
              ;
# 47 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 2
# 1 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/soft_crc/softcrc.h" 1
...
# 48 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h" 2
# 64 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_romdriver.h"
typedef enum {
...
# 31 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c" 2

# 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.h" 1
# 32 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.h"
...
# 33 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c" 2
...
blog_level_t _fsymf_level_hal_drvbl_flash;
const blog_info_t _fsymf_info_hal_drvbl_flash __attribute__((used, section(".static_blogfile_code." "hal_drvbl_flash"))) = { (blog_level_t *)(&_fsymf_level_hal_drvbl_flash), (char *)("hal_drv.bl_flash")};
...
# 34 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c" 2
...
static void _dump_flash_config()
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "======= FlashCfg magiccode @%p, code 0x%08lX =======\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c",


 96
# 93 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_flash.c"
    , &__boot2_flashCfg_src, boot2_flashCfg.magic); }} while(0==1);}


     ;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "mid \t\t0x%X\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c", 97, boot2_flashCfg.flashCfg.mid); }} while(0==1);};
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "clkDelay \t0x%X\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c", 98, boot2_flashCfg.flashCfg.clkDelay); }} while(0==1);};
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "clkInvert \t0x%X\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c", 99, boot2_flashCfg.flashCfg.clkInvert); }} while(0==1);};
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "sector size\t%uKBytes\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c", 100, boot2_flashCfg.flashCfg.sectorSize); }} while(0==1);};
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "page size\t%uBytes\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c", 101, boot2_flashCfg.flashCfg.pageSize); }} while(0==1);};
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ( (BLOG_LEVEL_INFO >= _fsymc_level_hal_drv) && (BLOG_LEVEL_INFO >= _fsymf_level_hal_drvbl_flash) ) { bl_printk("[%10u][%s: %s:%4d] " "---------------------------------------------------------------\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "bl_flash.c", 102); }} while(0==1);};
}
