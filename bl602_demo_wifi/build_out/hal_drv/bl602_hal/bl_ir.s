...
.LFB41:
	.file 1 "/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_ir.c"
	.loc 1 134 13
	.cfi_startproc
.LVL0:
	.loc 1 136 5
...
.LBE14:
	...
	.loc 1 103 75 is_stmt 0 discriminator 1
	lui	a5,%hi(_fsymc_level_hal_drv)
	.loc 1 103 55 discriminator 1
	lbu	a4,%lo(_fsymc_level_hal_drv)(a5)
	li	a5,1
	bgtu	a4,a5,.L7
	.loc 1 103 121 discriminator 3
	lui	a4,%hi(_fsymf_level_hal_drvbl_ir)
	.loc 1 103 100 discriminator 3
	lbu	a4,%lo(_fsymf_level_hal_drvbl_ir)(a4)
	bgtu	a4,a5,.L7
	.loc 1 103 155 is_stmt 1
.LBB16:
.LBB17:
...
.LBE16:
	...
	beq	a5,zero,.L8
	.loc 1 103 236 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL17:
.L9:
	.loc 1 103 155 discriminator 10
	lui	a3,%hi(.LC2)
	lui	a2,%hi(.LC3)
	mv	a1,a0
	lui	a0,%hi(.LC4)
...
.LBB18:
.LBB19:
	.loc 1 103 330 is_stmt 1 discriminator 11
	.loc 1 104 9 discriminator 11
	li	a0,1
	call	IR_Enable
.LVL19:
	.loc 1 105 9 discriminator 11
.LBE19:
.LBE18:
	.loc 1 113 1 is_stmt 0 discriminator 11
	lw	ra,12(sp)
	.cfi_remember_state
	.cfi_restore 1
.LBB23:
...
.LFE38:
	...
	.globl	_fsymf_info_hal_drvbl_ir
	.comm	_fsymf_level_hal_drvbl_ir,1,1
...
.LC1:
	...
	.byte	0
	.byte	1
	.section	.rodata.ir_interrupt_entry.str1.4,"aMS",@progbits,1
	.align	2
.LC2:
	.string	"bl_ir.c"
.LC3:
	...
	.zero	1
.LC4:
	.string	"[%10u][%s: %s:%4d] invalid data \r\n"
	.section	.rodata.str1.4,"aMS",@progbits,1
	.align	2
.LC5:
	.string	"hal_drv.bl_ir"
	.zero	2
.LC6:
	.string	"hal_drv"
...
_fsymc_info_hal_drv:
	...
	.word	.LC6
	.section	.static_blogfile_code.hal_drvbl_ir,"a"
	.align	2
	.type	_fsymf_info_hal_drvbl_ir, @object
	.size	_fsymf_info_hal_drvbl_ir, 8
_fsymf_info_hal_drvbl_ir:
	.word	_fsymf_level_hal_drvbl_ir
	.word	.LC5
	.text
.Letext0:
	...
	.file 8 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/RISCV/Device/Bouffalo/BL602/Startup/system_bl602.h"
	.file 9 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/bl602.h"
	.file 10 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_common.h"
	.file 11 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_ir.h"
	.file 12 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_gpio.h"
	.file 13 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_hbn.h"
	.file 14 "/Users/Sven/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h"
	.file 15 "/Users/Sven/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/task.h"
	.file 16 "/Users/Sven/bl_iot_sdk/components/utils/include/utils_list.h"
	.file 17 "/Users/Sven/bl_iot_sdk/components/sys/bloop/bloop/include/bloop.h"
	...
	.file 22 "/Users/Sven/bl_iot_sdk/components/sys/bloop/loopset/include/loopset_ir.h"
	.file 23 "<built-in>"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	_fsymf_level_hal_drvbl_ir
	.byte	0x26
	.4byte	.LASF342
	.byte	0x13
	.byte	0x53
	...
	.byte	0x5
	.byte	0x3
	.4byte	_fsymf_info_hal_drvbl_ir
	.byte	0x27
	.4byte	.LASF343
	.byte	0x1
	.byte	0xc7
...
.LASF148:
	.string	"_result"
.LASF342:
	.string	"_fsymf_info_hal_drvbl_ir"
.LASF160:
	.string	"__FILE"
.LASF245:
...
.LASF341:
	.string	"_fsymf_level_hal_drvbl_ir"
.LASF190:
...
.LASF153:
	.string	"_cvtbuf"
.LASF390:
	.string	"/Users/Sven/bl_iot_sdk/components/hal_drv/bl602_hal/bl_ir.c"
.LASF17:
	.string	"SEC_AES_IRQn"
.LASF366:
	.string	"ir_gpio_init"
